...
export default function About () {
    return (
        <div className="about">
            <h2 className="about__title">Conócenos</h2>
            <img src="http://placehold.it/960x320" className="about__img"/>
            <h3 className="about__subtitle">Ad tempor aliquip reprehenderit excepteur ut ut ex.</h3>
